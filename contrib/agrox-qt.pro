...
RESOURCES += src/qt/agrox.qrc src/qt/agrox_locale.qrc

TRANSLATIONS += src/qt/locale/agrox_bg.ts \
                src/qt/locale/agrox_de.ts \
                src/qt/locale/agrox_en.ts \
                src/qt/locale/agrox_es.ts \
                src/qt/locale/agrox_fi.ts \
                src/qt/locale/agrox_fr.ts \
                src/qt/locale/agrox_it.ts \
                src/qt/locale/agrox_ja.ts \
                src/qt/locale/agrox_pl.ts \
                src/qt/locale/agrox_pt.ts \
                src/qt/locale/agrox_ru.ts \
                src/qt/locale/agrox_sk.ts \
                src/qt/locale/agrox_sv.ts \
                src/qt/locale/agrox_vi.ts \
                src/qt/locale/agrox_zh_CN.ts \
                src/qt/locale/agrox_zh_TW.ts

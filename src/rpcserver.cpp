...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AGROX features */
        {"AGROX", "masternode", &masternode, true, true, false},
        {"AGROX", "listmasternodes", &listmasternodes, true, true, false},
        {"AGROX", "getmasternodecount", &getmasternodecount, true, true, false},
        {"AGROX", "masternodeconnect", &masternodeconnect, true, true, false},
        {"AGROX", "masternodecurrent", &masternodecurrent, true, true, false},
        {"AGROX", "masternodedebug", &masternodedebug, true, true, false},
        {"AGROX", "startmasternode", &startmasternode, true, true, false},
        {"AGROX", "createmasternodekey", &createmasternodekey, true, true, false},
        {"AGROX", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"AGROX", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"AGROX", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"AGROX", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"AGROX", "getmasternodescores", &getmasternodescores, true, true, false},
        {"AGROX", "mnbudget", &mnbudget, true, true, false},
        {"AGROX", "preparebudget", &preparebudget, true, true, false},
        {"AGROX", "submitbudget", &submitbudget, true, true, false},
        {"AGROX", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"AGROX", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"AGROX", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"AGROX", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"AGROX", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"AGROX", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"AGROX", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"AGROX", "checkbudgets", &checkbudgets, true, true, false},
        {"AGROX", "mnsync", &mnsync, true, true, false},
        {"AGROX", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> AGROX-cli " + methodname + " " + args + "\n";
}

...
// Copyright (c) 2017 The AGROX developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1540804510, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // AGROX: 1 day
        nTargetSpacing = 1 * 60;  // AGROX: 2 minutes
        nMaturity = 75;
        ...
        nLastPOWBlock = 150;
        nModifierUpdateBlock = 1; // we use the version 2 for AGX

        const char* pszTimestamp = "New World With Black Night-AGX";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1540804510;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 970554;

		 

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000005d29b75a7467572d503bdc0fee2fe8418f9d19261d18efb9d2736f21e1"));
        ...
        // AGROX BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // AGROX BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // AGROX BIP44 coin type is '222' (0x800000de)
        ...
        strMasternodePoolDummyAddress = "AAKzgFX8EZt3fwzkPv55Q3sZJauPNdR8DQ";
		nStartMasternodePayments = 1540804510; // 24 hours after genesis creation
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // AGROX: 1 day
        nTargetSpacing = 2 * 60;  // AGROX: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        // Testnet AGROX addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet AGROX script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet AGROX BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet AGROX BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // AGROX: 1 day
        nTargetSpacing = 2 * 60;        // AGROX: 1 minutes

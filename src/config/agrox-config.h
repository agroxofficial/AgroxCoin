/* src/config/agrox-config.h.  Generated from agrox-config.h.in by configure.  */
/* src/config/agrox-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "AGROX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AGROX Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "agrox"

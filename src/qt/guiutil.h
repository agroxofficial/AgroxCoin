...
/** Utility functions used by the AGXcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render AGX addresses in monospace font
...
// Parse "agrox:" URI into recipient object, return true on successful parsing

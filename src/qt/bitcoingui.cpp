                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AGROX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AGX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and agrox: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AGROX Core"), this);
    aboutAction->setStatusTip(tr("Show information about AGROX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AGROX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AGX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AGX addresses"));
    ...
    openAction->setStatusTip(tr("Open a agrox: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AGROX Core help message to get a list with possible AGROX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AGROX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AGROX network", "", count));
}
...
{
    QString strTitle = tr("AGROX Core"); // default title

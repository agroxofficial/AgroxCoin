...
Intro
-----
AGROX (AGX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. AGROX utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run agrox-qt.exe.

AGROX Core is the original AGROX client and it builds the backbone of the network.
However, it downloads and stores the entire history of AGROX transactions;

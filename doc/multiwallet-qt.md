...
In order to support loading of multiple wallets in agrox-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is agrox.cpp.
...
Changes to agrox.cpp
----------------------
agrox.cpp is the entry point into agrox-qt, and as such, will require some minor modifications to provide hooks for

Contributing to AGROX Core
==================================

The AGROX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AGROX Core project, and is not to be
confused with overall AGROX Network Protocol consensus changes.

Whether a pull request is merged into AGROX Core rests with the project merge
...
Patches that change AGROX consensus rules are considerably more involved than
...
Where a patch set proposes to change the AGROX consensus, it must have been
...
The project leader is the release manager for each AGROX Core release.

...
#   c) node1 mines 32 blocks, so now node 0 has 500000AGX, node 1 has 4250AGX, node2 has none.
#   d) node0 sends 601 AGX to node2, in two transactions (301 AGX, then 300 AGX).
